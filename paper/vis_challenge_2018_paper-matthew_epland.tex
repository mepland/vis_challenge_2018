...
\makeatletter\hypersetup{
    ...
    pdftitle       = {Epland - Duke Visualization Challenge 2018}, % was including the subtitle as well and I wanted to shorten/tweak it....
    pdfsubject     = {},               %
...
\bibliographystyle{\includedir/atlasBibStyleWithTitle}
\bibliography{\includedir/bib.bib}
