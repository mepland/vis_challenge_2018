...
%  \vfill % TODO add in depending on final block sizes
...
% TODO if there is room at the end, might as well put a bullet in for the sprint_pos and cite if possible
      \end{itemize}
    \end{itemize}
  \end{myblock}\vfill
...
%  \vfill % TODO add in depending on final block sizes
  ...
  \begin{myblock}{References} % TODO if there is only one in the end, change to reference?
